...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				...
				生日:<input placeholder="开始时间" id="txt_search_start" name="start" class="laydate-icon form-control layer-date"/>
	...
	<!-- 导入 -->
	<div class="modal fade" id="modal_user_edit1" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user1" method="post" action="inExcel.htm" enctype="multipart/form-data">
						请选择Excel文件:<input type="file" name="excle" id="exid"/>
						
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_user_btn1">保存</button>
	...
	<!-- 柱状图 -->
	<div class="modal fade" id="modal_user_edit2" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	<!-- 饼状图 -->
	<div class="modal fade" id="modal_user_edit3" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	<div class="modal fade" id="modal_user_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="addStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>性别：</td>
								<td><input type="radio" id="sex1" name="sex" aria-required="true" value = "男" required/>男
								<input type="radio" id="sex2" name="sex" aria-required="true" value = "女" required/>女</td>
							</tr>
							<tr>
								<td>生日：</td>
								...
								<td>爱好：</td>
								<td>
									<input type="checkbox" id="hobby1" name="hobbys" value ="OLO"/> OLO
									<input type="checkbox" id="hobby2" name="hobbys"  value ="吃鸡"/> 吃鸡
									<input type="checkbox" id="hobby3" name="hobbys" value ="王者农药"/> 王者农药
									<input type="checkbox" id="hobby4" name="hobbys" value ="WOW"/> WOW
								</td>
							</tr>
							<tr>
								<td>班级：</td>
	...
	<!--导出对话框 -->
	<div class="modal fade" id="modal_user_del1" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				...
				<div class="modal-footer">
				<button type="button" class="btn btn-danger"  id="del_user_btn1">导出</button>
				<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
			</div>
			</div>
		</div>
	...
	$(function () {
	    ...
	    $("#submit_form_user_btn1").click(function(){
	    	$("#form_user1").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_in").click(function(){
	    		...
	    		$('#modal_user_edit1').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_edit1').modal('show');
	        });
	    	...
	    	$("#btn_out").click(function(){
	    		var getSelections = $('#table_user').bootstrapTable('getSelections');
	    		if(getSelections && getSelections.length>0){
	    			$('#modal_user_del1').modal({backdrop: 'static', keyboard: false});
	    			$("#modal_user_del1").show();
	    		}else{
	    			$("#select_message").text("请选择数据");
	    			$("#alertmod_table_user_mod").show();
	    		}
	    	...
	    	$("#btn_bar").click(function(){
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	if(res.success){
	    		    		...
	    		    		for (var i = 0; i < res.list.length; i++) {
								xdata[i] = res.list[i].gname;
								ydata[i] = res.list[i].num;
							}
	    		    		//柱状图数据加载
	    		...
	    		$('#modal_user_edit2').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_edit2').modal('show');
	        });
	    	...
	    	$("#btn_pie").click(function(){
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
    		    		...
    		    		for (var i = 0; i < res.list.length; i++) {
							xdata[i] = res.list[i].gname;
							var clazz={};
							clazz.value=res.list[i].num;
							clazz.name=res.list[i].gname;
							ydata[i] = clazz;
						}
	    		    	if(res.success){
	    		...
	    		$('#modal_user_edit3').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_edit3').modal('show');
	        });
