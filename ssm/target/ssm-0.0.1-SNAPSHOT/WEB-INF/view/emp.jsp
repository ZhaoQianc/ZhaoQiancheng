        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="age1" class="form-control" id="txt_search_age" >-
			      <input type="text" name="age2" class="form-control" id="txt_search_age" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">性别 </span>
			      <input type="radio" name="tbEmpSex" value="男" id="txt_search_tbEmpSex" >男
			      <input type="radio" name="tbEmpSex" value="女" id="txt_search_tbEmpSex" >女
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>地址：</td>
								<td><input type="text" id="tbEmpAddress" name="tbEmpAddress"
									 aria-required="true" />
							...
							<tr>
								<td>头像：</td>
								<td><input type="file" id="tbEmpImg" name="tbEmpImg"/>
								     <img alt="xx" id="pic" src="" name="">
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>地址：</td>
								<td><input type="text" id="tbEmpAddress" name="tbEmpAddress"
